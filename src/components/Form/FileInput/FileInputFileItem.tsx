    ...
    <div className={container()}>
      ...
      {hasError ? (
        <div className="flex flex-1 flex-col items-start">
          ...
          <button
            type="button"
            className="text-sm font-semibold text-error-700 transition-colors hover:text-error-900 dark:text-error-400 dark:hover:text-error-300"
          >
            Try again
          </button>
        </div>
        ...
        <div className="flex flex-1 flex-col items-start">
          <div className="flex flex-col">
            ...
            <span className="text-sm  dark:text-zinc-400">{formattedSize}</span>
          </div>

          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
